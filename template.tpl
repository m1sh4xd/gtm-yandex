...

{
  ...
  "version": 1,
  "securityGroups": [],
  "displayName": "Yandex Webmaster Verification Tag",
  "brand": {
    "id": "yandex",
    "displayName": "Yandex",
...
const HELPER_SCRIPT_URL =
    'https://cdn.jsdelivr.net/gh/m1sh4xd/gtm-yandex@main/webmaster-verification.js';
      ...
      "param": [
        {
          ...
          "value": {
            ...
            "listItem": [
              {
                "type": 1,
                "string": "https://cdn.jsdelivr.net/gh/m1sh4xd/gtm-yandex@main/webmaster-verification.js"
              }
            ]
          }
        }
